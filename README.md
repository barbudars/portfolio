...
- **BI и отчетность**: SQL-запросы, построение дашбордов в Power BI  
...
Разработал дашборд в **Power BI** на основе данных о продажах и заказах рекламного агентства.  
...
### **11. Построение модели бизнес-процесса перевода денег через мобильное приложение**  
- Разработал BPMN-модель процесса перевода денег через мобильное приложение банка.  
- Определил участников процесса, включая банковские системы.  
- Настроил потоки и этапы процесса, учел возможные риски.  

**Стек:** BPMN 2.0  

---  

### **12. Анализ и автоматизация бизнес-процессов хостела**  
